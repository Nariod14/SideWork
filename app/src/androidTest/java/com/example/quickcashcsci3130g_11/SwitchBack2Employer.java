...
public class SwitchBack2Employer {
    @Rule
    public ActivityScenarioRule<EmployeeProfileActivity> ActivityRule = new ActivityScenarioRule<>(EmployeeProfileActivity.class);
    ...
    public void setup() {
        ...
        ActivityScenario.launch(EmployeeProfileActivity.class);
    }
